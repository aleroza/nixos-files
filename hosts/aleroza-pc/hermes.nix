...

{
  ...
  services.hermes-agent = {
    ...
    environment = {
      ...
      # OPENVIKING_API_KEY is supplied via the EnvironmentFile at
      # /etc/openviking/client.env, which is generated by
      # modules/services/openviking.nix from the same sops secret
      # (aleroza.yaml hermes.GOOGLE_API_KEY) that the server's
      # server.root_api_key is rendered from. Same value on both
      # ends → bearer auth succeeds.
    };
